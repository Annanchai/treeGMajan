  ...
  <div class="result">
    ...
    <div class="input">
      <form method="POST">
        ...
        <input type="submit" value="Filter" class="button" name="filter">
        <input type="submit" value="Display all" class="button" name="displayAll" formaction="feedback-result.php">
      </form>
